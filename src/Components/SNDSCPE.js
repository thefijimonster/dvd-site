        ...
        <section>
            ...
            <div id="contentDiv">
                ...
                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px', marginTop: '30px'}}>
                    ...
                    {/* <h4 style={{backgroundColor: 'red', fontSize: '30px'}}>SANDSCAPE</h4> */}
                    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '30px', marginBottom: '-50px',  paddingRight: '8px', paddingLeft: '8px'}}>
                        <p style={{width: '480px', textAlign: 'center', color: 'red', fontWeight: 'bolder', fontSize: '20px', lineHeight: '24px'}}>
                            CREATING AN INTERACTION-CENTERED SYSTEM EXCERCISING AN APPLICATION OF PHYSICAL COMPUTING
                            <br></br>
                            <span style={{color: 'white', fontSize: '14px'}}>[ UNIVERSITY PROJECT ]</span>
                        </p>
                    ...
                    <img src={SANDSCAPE1} style={{mixBlendMode: 'exclusion', width: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px', marginBottom: '10px'}}></img>
                    <p style={{width: '480px', textAlign: 'center'}}>JAPANESE DRY GARDEN [KARESANSUI] TEMPLES ARE EPHEMERAL IN NATURE, DOWN TO THE RAKED SAND AND POSITIONING OF ROCKS, WHICH SYMBOLISE NATURAL ELEMENTS. THIS PROJECT WAS A EXPLORATION OF INTERACTION-INDUCED METAMORPHOSIS IN A TRADITIONALLY UNCHANGING ENVIRONMENT.</p>
                    {/* <h3 style={{marginTop: '20px'}}>[USER INTERACTION]</h3> */}
                    <div style={{display: 'flex', columnGap: '20px', marginTop: '10px', marginBottom: '20px'}}>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE3} style={{mixBlendMode: 'lighten', width: '160px'}}></img>
                            <p style={{textAlign: 'center', width: '140px', marginTop: '25px'}}>PLACE OBJECT IN SANDBOX</p>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE4} style={{mixBlendMode: 'lighten', width: '140px'}}></img>
                            <p style={{textAlign: 'center', width: '140px', marginTop: '15px'}}>SANDSCAPE DETECTS OBJECT AND PROCEEDS TO DRAW CONCENTRIC SHAPES AROUND THE OBJECT.</p>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE5} style={{mixBlendMode: 'lighten', width: '160px'}}></img>
                            <p style={{textAlign: 'center', width: '140px', marginTop: '25px'}}>REMOVE OBJECT AND MOVE OR PLACE A NEW OBJECT IN SANDBOX</p>
                        </div>
                    </div>
                    {/* <h3 style={{marginTop: '10px', marginBottom: '20px', width: '150px', textAlign: 'center'}}>[HOW IT WORKS]</h3> */}
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', marginBottom: '30px', width: '100%'}}>
                        <img className='galleryImg' src={SANDSCAPE8} style={{mixBlendMode: 'lighten', filter: 'grayscale(100%) contrast(80%)', width: '480px'}}></img>
                        <img className='galleryImg' src={SANDSCAPE7} style={{mixBlendMode: 'lighten', filter: 'grayscale(100%) contrast(80%)', width: '480px'}}></img>
                        <img className='galleryImg' src={SANDSCAPE6} style={{mixBlendMode: 'lighten', filter: 'grayscale(100%) contrast(80%)', width: '480px'}}></img>
                        {/* <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                            <img className='bw-image' src={SANDSCAPE8} style={{mixBlendMode: 'lighten', width: '100px'}}></img>
                            <p style={{textAlign: 'left', width: '380px', marginLeft: '20px', lineHeight: '14px'}}>
                                <span style={{color: 'red'}}>VIDEO</span> WAS STREAMED LOCALLY FROM AN <span style={{color: 'red'}}>ESP32 CAMERA</span>. VIDEO WAS PROCESSED USING <span style={{color: 'red'}}>SCIKIT-IMAGE</span> FOR EDGE-DETECTION.
            ...
            <div id="contentDiv">
                ...
                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px', marginTop: '30px'}}>
                    ...
                    <img src={SANDSCAPE1} style={{mixBlendMode: 'exclusion', width: '380px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px', marginBottom: '10px'}}></img>
                    <p style={{width: '350px', textAlign: 'center'}}>JAPANESE DRY GARDEN [KARESANSUI] TEMPLES ARE EPHEMERAL IN NATURE, DOWN TO THE RAKED SAND AND POSITIONING OF ROCKS, WHICH SYMBOLISE NATURAL ELEMENTS. THIS PROJECT WAS A EXPLORATION OF INTERACTION-INDUCED METAMORPHOSIS IN A TRADITIONALLY UNCHANGING ENVIRONMENT.</p>
                    {/* <h3 style={{marginTop: '20px'}}>[USER INTERACTION]</h3> */}
                    <div style={{display: 'flex', flexDirection: 'column', columnGap: '20px', marginTop: '10px', marginBottom: '20px'}}>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE3} style={{mixBlendMode: 'lighten', width: '200px'}}></img>
                            <p style={{textAlign: 'center', width: '200px', marginTop: '25px'}}>PLACE OBJECT IN SANDBOX</p>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE4} style={{mixBlendMode: 'lighten', width: '180px'}}></img>
                            <p style={{textAlign: 'center', width: '180px', marginTop: '15px'}}>SANDSCAPE DETECTS OBJECT AND PROCEEDS TO DRAW CONCENTRIC SHAPES AROUND THE OBJECT.</p>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <img className='invert' src={SANDSCAPE5} style={{mixBlendMode: 'lighten', width: '200px'}}></img>
                            <p style={{textAlign: 'center', width: '200px', marginTop: '25px'}}>REMOVE OBJECT AND MOVE OR PLACE A NEW OBJECT IN SANDBOX</p>
                        </div>
                    </div>
                    {/* <h3 style={{marginTop: '10px', marginBottom: '20px', width: '150px', textAlign: 'center'}}>[HOW IT WORKS]</h3> */}
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px', marginBottom: '30px'}}>
                        <img className='galleryImg' src={SANDSCAPE8} style={{mixBlendMode: 'lighten', width: '380px', filter: 'grayscale(100%) contrast(80%)'}}></img>
                        <img className='galleryImg' src={SANDSCAPE7} style={{mixBlendMode: 'lighten', width: '380px', filter: 'grayscale(100%) contrast(80%)'}}></img>
                        <img className='galleryImg' src={SANDSCAPE6} style={{mixBlendMode: 'lighten', width: '380px', filter: 'grayscale(100%) contrast(80%)'}}></img>
                        {/* <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                            <img className='bw-image' src={SANDSCAPE8} style={{mixBlendMode: 'lighten', width: '100px'}}></img>
                            <p style={{textAlign: 'left', width: '380px', marginLeft: '20px', lineHeight: '14px'}}>
                                <span style={{color: 'red'}}>VIDEO</span> WAS STREAMED LOCALLY FROM AN <span style={{color: 'red'}}>ESP32 CAMERA</span>. VIDEO WAS PROCESSED USING <span style={{color: 'red'}}>SCIKIT-IMAGE</span> FOR EDGE-DETECTION.
