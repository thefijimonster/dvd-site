            ...
            <MediaQuery maxWidth={600} minWidth={500}>
                ...
                <div id="contentDiv">
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px', marginTop: '30px', marginBottom: '40px'}}>
                        ...
                        <div style={{marginLeft: '-40px', marginBottom: '40px', width: '350px'}}>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px'}}>FREQUENCY RESPONSE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left'}}>50Hz-20kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px'}}>IMPEDANCE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left'}}>8 Ohms</p>
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '20px'}}>
                                <p style={{width: '300px', textAlign: 'right', marginLeft: '50px'}}>MID/HIGH-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '300px', textAlign: 'left'}}>1-1/8-INCH TREATED SILK DOME </p>
                            </div>
                        </div>
                        <p style={{display: 'none', fontSize: '14px', fontWeight: 'bolder'}}>PHOTO GALLERY</p>
                        ...
                        <div style={{marginLeft: '-40px', marginBottom: '40px', width: '350px'}}>
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '30px'}}>
                                <p style={{width: '300px', textAlign: 'right', marginLeft: '50px'}}>MID/HIGH-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '300px', textAlign: 'left'}}>1.25-INCH ALUMINIUM DOME TWEETER </p>
                            </div>
                        </div>
                        <p style={{width: '500px', textAlign: 'center'}}>DOCUMENTATION BOOKLET STILL TO BE CREATED.</p>
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px', marginTop: '30px', marginBottom: '40px'}}>
                        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '30px', marginBottom: '10px',  paddingRight: '8px', paddingLeft: '8px'}}>
                            <p style={{width: '350px', textAlign: 'center', color: 'red', fontWeight: 'bolder', fontSize: '20px', lineHeight: '24px'}}>
                                AN EXPLORATION INTO APPLYING MY INTER-DISCIPLINARY PRACTISE WITH ART [MUSIC] TO CREATE A FOUR-POINT LOUDSPEAKER SYSTEM
                                <br></br>
                                <span style={{color: 'white', fontSize: '12px'}}>[ SELF-LED PROJECT ]</span>
                            </p>
                        </div>
                        <a href="https://dvd-folio.s3.eu-west-2.amazonaws.com/SPKRDSGN001.pdf">
                            <img className="galleryImg" style={{width: '340px', mixBlendMode: 'normal', marginTop: '-20px'}} src={require('../Assets/PAGE_ONE.png')}></img>
                        </a>

                        {/* <h6 style={{fontSize: '30px', marginTop: '-235px', backgroundColor: 'white', marginBottom: '235px', mixBlendMode: 'normal'}}>[CLICK TO <span style={{width: '100px'}}></span> VIEW DOCUMENT]</h6> */}

                        <div  style={{backgroundColor: 'red', color: 'black', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <div style={{display: 'flex', flexDirection: 'column', textAlign: 'center', color: 'black', marginTop: '10px'}}>
                            <p style={{width: '350px', fontSize: '12px', lineHeight: '14px', color: 'black', fontWeight: 'bold'}}>TWO-WAY BOOKSHELF LOUDSPEAKER CONSISTING OF 6.5" DS175 WOOFER PAIRED WITH DC28F-8 DOME TWEETER IN BASS-REFLEX DESIGN WITH FRONT-FIRING TUNED PORT</p>
                            {/* <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '600px'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px'}}>FREQUENCY RESPONSE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left'}}>50Hz-20kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '600px'}}>
                        ...
                        <br></br>
                        <div style={{display: 'flex', width: '500px', alignItems: 'center', gap: '12px', justifyContent: 'center', marginTop: '-30px'}}>
                            <img style={{width: '104px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR1SIDE.png')}></img>
                            <img style={{width: '120px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR1TOP.png')}></img>
                            <img style={{width: '110px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR1FRONT.png')}></img>
                        </div>
                        <div style={{marginLeft: '-40px', marginBottom: '40px', width: '350px'}}>
                        <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>FREQUENCY RESPONSE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>50Hz-20kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>IMPEDANCE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>8 Ohms</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>SENSITIVITY</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>88 dB</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>CROSSOVER FREQUENCY</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>1.0 kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '20px'}}>
                                <p style={{width: '300px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>LOW/MID-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '300px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>6.5-INCH COATED PAPER CONE WOOFER</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '20px'}}>
                                <p style={{width: '300px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>MID/HIGH-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '300px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>1-1/8-INCH TREATED SILK DOME </p>
                            </div>
                        </div>
                        </div>
                        <p style={{display: 'none', fontSize: '14px', fontWeight: 'bolder'}}>PHOTO GALLERY</p>
                        ...
                        <div style={{backgroundColor: 'red', color: 'black', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <div style={{display: 'flex', flexDirection: 'column', textAlign: 'center', backgroundColor: 'red'}}>
                            <p style={{width: '350px', fontSize: '12px', lineHeight: '14px', color: 'black', fontWeight: 'bold'}}>VINTAGE-STYLED DESIGN OF TWO-WAY LOUDSPEAKER WITH A 8" FOSTEX FF225WK FULL RANGE AND ALUMINIUM BEYMA DOME TWEETER IN BASS-REFLEX DESIGN WITH FRONT-FIRING TUNED PORT</p>
                            {/* <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '800px'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px'}}>FREQUENCY RESPONSE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left'}}>40Hz-20kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '800px'}}>
                        ...
                        {/* <img style={{mixBlendMode: 'exclusion', width: '350px', marginTop: '10px'}} src={SPEAKER2}></img> */}
                        {/* <h4 style={{backgroundColor: 'red', fontSize: '30px', marginTop: '30px'}}>SPKRDSGN002</h4> */}
                        <div style={{display: 'flex', width: '500px', gap: '12px', alignItems: 'center', justifyContent: 'center', backgroundColor: 'none'}}>
                            <img style={{width: '106px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR2SIDE.png')}></img>
                            <img style={{width: '110px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR2TOP.png')}></img>
                            <img style={{width: '120px', height: 'auto', marginTop: '10px'}} src={require('../Assets/SPKR2FRONT.png')}></img>
                        </div>
                        <div style={{marginLeft: '-40px', marginBottom: '40px', width: '350px'}}>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>FREQUENCY RESPONSE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>40Hz-20kHz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>IMPEDANCE</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>8 Ohms</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>SENSITIVITY</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>93 dB</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%'}}>
                                <p style={{width: '200px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>CROSSOVER FREQUENCY</p><p style={{paddingLeft: '20px', width: '200px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>900 Hz</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '20px'}}>
                                <p style={{width: '400px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>LOW/MID-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '400px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>8-INCH DOUBLE LAYER PAPER CONE FULL RANGE</p>
                            </div>
                            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', height: '20px', width: '100%', marginTop: '30px'}}>
                                <p style={{width: '300px', textAlign: 'right', marginLeft: '50px', color: 'black', fontWeight: 'bold'}}>MID/HIGH-FREQUENCY TRANSDUCER</p><p style={{paddingLeft: '20px', width: '300px', textAlign: 'left', color: 'black', fontWeight: 'bold'}}>1.25-INCH ALUMINIUM DOME TWEETER </p>
                            </div>
                        </div>
                        <p style={{width: '350px', textAlign: 'center', color: 'black'}}>DOCUMENTATION BOOKLET STILL TO BE CREATED.</p>
                        </div>
                        {/* <div style={{overflowX: 'scroll', width: '500px', whiteSpace: 'nowrap', alignItems: 'center'}}>
                            <img className='speaker-pdf' src={SPKR0021}></img>
                            <img className='speaker-pdf' src={SPKR0022}></img>
                        ...
                        {/* <div style={{
                            ...
                            {/* <h4 className='revealLabel' style={{fontSize: '14px', marginTop: '-15px', backgroundColor: 'red'}}>[SEE SYSTEM IN USE]</h4> */}
                            <img style={{width: '450px', height: 'auto', mixBlendMode: 'lighten', marginTop: '40px'}} src={FLOOR1}></img>
                        {/* </div> */}
                    </div>
                </div>
            </MediaQuery>
