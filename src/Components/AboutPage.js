    ...
    return(
        <section>
            ...
            <div id="contentDiv">
                    <Back></Back>
                    <div>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', marginTop: '60px'}}>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                            ...
                            <p style={{width: '240px', textAlign: 'center', fontSize: '11px', marginTop: '20px'}}>
            ...
            <div id="contentDiv">
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px'}}>
                        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                            <img className="galleryImg" style={{width: '340px'}}  src={require('../Assets/ABOUT3.png')}></img>
                            {/* <h4 style={{backgroundColor: 'red', fontSize: '30px', marginTop: '-30px'}}>ABOUT ME</h4> */}
                            <p style={{width: '350px', textAlign: 'center', fontSize: '11px', lineHeight: '16px', marginTop: '20px'}}>
                                Currently studying <span style={{color: 'red'}}>Design Engineering MEng [3rd year]</span> at the Dyson School of Design Engineering at Imperial College London.
                                I carry a holistic cross-disciplinary approach to my practise.
                            <br></br>
                            <br></br>
